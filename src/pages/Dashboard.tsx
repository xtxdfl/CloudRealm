...
export default function Dashboard() {
  ...
  // Mock Services List (Ambari Style Sidebar)
  const services = [
    { name: 'HDFS', status: 'healthy' },
    { name: 'YARN', status: 'healthy' },
    { name: 'MAPREDUCE2', status: 'healthy' },
    { name: 'TEZ', status: 'healthy' },
    { name: 'HIVE', status: 'warning' },
    { name: 'HBASE', status: 'healthy' },
    { name: 'PIG', status: 'stopped' },
    { name: 'SQOOP', status: 'stopped' },
    { name: 'OOZIE', status: 'healthy' },
    { name: 'ZOOKEEPER', status: 'healthy' },
    { name: 'FALCON', status: 'stopped' },
    { name: 'STORM', status: 'stopped' },
    { name: 'SPARK', status: 'healthy' },
    { name: 'SPARK2', status: 'healthy' },
    { name: 'AMBARI METRICS', status: 'healthy' },
    { name: 'ATLAS', status: 'healthy' },
    { name: 'KAFKA', status: 'healthy' },
    { name: 'KNOX', status: 'stopped' },
    { name: 'LOGSEARCH', status: 'healthy' },
  ];
