...
ACTION=$1
cloud_AGENT_ROOT_DIR="/usr/local/${cloud_UNIT}"
cloud_SERVER_ROOT_DIR="/usr/local/cloud-server"
...
OLD_COMMON_DIR="/usr/local/python2.6/site-packages/cloud_commons"
OLD_RESOURCE_MANAGEMENT_DIR="/usr/local/python2.6/site-packages/resource_management"
OLD_JINJA_DIR="/usr/local/python2.6/site-packages/cloud_jinja2"
OLD_SIMPLEJSON_DIR="/usr/local/python2.6/site-packages/cloud_simplejson"
OLD_cloud_AGENT_DIR="/usr/local/python2.6/site-packages/cloud_agent"
