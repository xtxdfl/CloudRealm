...
from cloud_agent.Register import Register
from cloud_agent.Utils import BlockingDictionary
from cloud_agent.Utils import Utils
from cloud_agent.ComponentVersionReporter import ComponentVersionReporter
from cloud_agent.listeners.TopologyEventListener import TopologyEventListener
from cloud_agent.listeners.ConfigurationEventListener import ConfigurationEventListener
from cloud_agent.listeners.AgentActionsListener import AgentActionsListener
from cloud_agent.listeners.MetadataEventListener import MetadataEventListener
from cloud_agent.listeners.CommandsEventListener import CommandsEventListener
from cloud_agent.listeners.HostLevelParamsEventListener import (
  HostLevelParamsEventListener,
)
from cloud_agent.listeners.AlertDefinitionsEventListener import (
  AlertDefinitionsEventListener,
)
from cloud_agent.listeners.EncryptionKeyListener import EncryptionKeyListener
...
class HeartbeatThread(threading.Thread):
  ...
  def blocking_request(
    ...
    try:
      ...
      # this happens when trying to connect to broken connection. Happens if cloud-server is restarted.
