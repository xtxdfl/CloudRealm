...
class Markup(str):
  ...
  def unescape(self):
    ...
    """
    from cloud_jinja2._markupsafe._constants import HTML_ENTITIES
...
try:
  from cloud_jinja2._markupsafe._speedups import escape, escape_silent, soft_unicode
except ImportError:
  from cloud_jinja2._markupsafe._native import escape, escape_silent, soft_unicode
