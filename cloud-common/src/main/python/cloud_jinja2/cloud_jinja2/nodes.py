...
from cloud_jinja2.utils import Markup, MethodType, FunctionType
...
class ExtensionAttribute(Expr):
  ...
  :meth:`~cloud_jinja2.ext.Extension.attr` method on an extension.
  """
...
class InternalName(Expr):
  ...
  :meth:`~cloud_jinja2.parser.Parser.free_identifier` method that creates
...
class ContextReference(Expr):
  ...
  current :class:`~cloud_jinja2.runtime.Context` object.
...
class ScopedEvalContextModifier(EvalContextModifier):
  ...
  :class:`~cloud_jinja2.nodes.EvalContext` for nodes in the :attr:`body`.
  """
