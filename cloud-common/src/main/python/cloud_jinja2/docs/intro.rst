...
1.  Install `git`_
2.  ``git clone git://github.com/mitsuhiko/cloud_jinja2.git``
3.  ``cd cloud_jinja2``
4.  ``ln -s cloud_jinja2 /usr/lib/python3.X/site-packages``
...
:class:`~cloud_jinja2.Template`.  This however is not the recommended way to
work with it if your templates are not loaded from strings but the file
system or another data source:

>>> from cloud_jinja2 import Template
>>> template = Template('Hello {{ name }}!')
>>> template.render(name='John Doe')
u'Hello John Doe!'

By creating an instance of :class:`~cloud_jinja2.Template` you get back a new template
object that provides a method called :meth:`~cloud_jinja2.Template.render` which when
...
.. _Jinja bug tracker: http://github.com/mitsuhiko/cloud_jinja2/issues
