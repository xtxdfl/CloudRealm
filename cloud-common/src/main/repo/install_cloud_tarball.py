...
DESCRIPTION = "URL should point to full tar.gz location e.g.: https://public-repo-1.hortonworks.com/something/cloud-server.tar.gz"

logger = logging.getLogger("install_cloud_tarball")
...
class Runner:
  def parse_opts(self):
    ...
    parser.add_option(
      ...
      dest="root_folder",
      default="/",
      help="root folder to install Cloud to. E.g.: /opt",
    )
    parser.add_option(
      "-d",
      "--dependencies-skip",
