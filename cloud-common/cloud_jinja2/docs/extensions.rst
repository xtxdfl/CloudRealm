...
example creates a Jinja2 environment with the i18n extension loaded::
    ...
    jinja_env = Environment(extensions=['cloud_jinja2.ext.i18n'])
...
**Import name:** `cloud_jinja2.ext.i18n`
...
.. method:: cloud_jinja2.Environment.install_gettext_translations(translations, newstyle=False)
...
.. method:: cloud_jinja2.Environment.install_null_translations(newstyle=False)
...
.. method:: cloud_jinja2.Environment.install_gettext_callables(gettext, ngettext, newstyle=False)
...
.. method:: cloud_jinja2.Environment.uninstall_gettext_translations()

    Uninstall the translations again.

.. method:: cloud_jinja2.Environment.extract_translations(source)
...
translation methods to the environment at environment generation time::
    ...
    env = Environment(extensions=['cloud_jinja2.ext.i18n'])
...
**Import name:** `cloud_jinja2.ext.do`
...
**Import name:** `cloud_jinja2.ext.loopcontrols`
...
**Import name:** `cloud_jinja2.ext.with_`
...
**Import name:** `cloud_jinja2.ext.autoescape`
...
Extensions always have to extend the :class:`cloud_jinja2.ext.Extension` class:
...
.. autoclass:: cloud_jinja2.parser.Parser
    ...
    .. attribute:: stream
        ...
        The current :class:`~cloud_jinja2.lexer.TokenStream`

.. autoclass:: cloud_jinja2.lexer.TokenStream
   :members: push, look, eos, skip, next, next_if, skip_if, expect

   .. attribute:: current

        The current :class:`~cloud_jinja2.lexer.Token`.

.. autoclass:: cloud_jinja2.lexer.Token
...
.. autofunction:: cloud_jinja2.lexer.count_newlines
...
For more information have a look at the repr of :meth:`cloud_jinja2.Environment.parse`.

.. module:: cloud_jinja2.nodes
