...
from cloud_stomp.adapter.multicast import MulticastConnection
import cloud_stomp.colors
from cloud_stomp.connect import (
  cloud_stompConnection10,
  StompConnection11,
  StompConnection12,
)
from cloud_stomp.listener import ConnectionListener, StatsListener

sys.path.append(".")
import cloud_stomp as stomp
