...
do_backups(){
  local etc_dir="/etc/cloud-agent"
  local var_dir="/var/lib/cloud-agent"
...
cloud-agent.ini::${etc_dir}/conf/cloud-agent.ini:${etc_dir}/conf/cloud-agent.ini.old
sudoers:Please restore the file if you were using it for cloud-agent non-root functionality:${sudoers_dir}/cloud-agent:${sudoers_dir}/cloud-agent.bak"
