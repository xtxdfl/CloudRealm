...
if ($packageParameters) {
  ...
  if ($arguments.ContainsKey("CloudRoot")) {
    Write-Debug "CloudRoot Argument Found"
    $cloudRoot = $arguments["CloudRoot"]
  }
...
$link = "$cloudRoot\$packageName"
$target = "$cloudRoot\$packageName-$packageVersion"
