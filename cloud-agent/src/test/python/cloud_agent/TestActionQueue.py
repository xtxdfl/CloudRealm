...
from cloud_agent.ActionQueue import ActionQueue, hide_passwords
...
from cloud_agent.models.commands import CommandStatus, AgentCommand
...
from cloud_agent.ActualConfigHandler import ActualConfigHandler
...
class TestActionQueue(TestCase):
  ...
  background_command = {
    ...
    "cloudLevelParams": {"jdk_location": "test"},
    "clusterId": CLUSTER_ID,
  }
  ...
  @patch.object(CloudConfig, "get_parallel_exec_option")
  ...
  def test_log_execution_commands(
    ...
    config.set("agent", "cache_dir", "/var/lib/cloud-agent/cache")
    config.set("agent", "tolerate_download_failures", "true")
