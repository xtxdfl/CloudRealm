...
import unittest
from cloud_commons.ast_checker import ASTChecker, BlacklistRule
from cloud_agent.alerts.metric_alert import JmxMetric
from cloud_agent.alerts.ams_alert import AmsMetric
