...
from cloud_agent.Controller import Controller
from cloud_agent.Heartbeat import Heartbeat
from cloud_agent.ActionQueue import ActionQueue
from cloud_agent import CloudConfig
...
class TestController(TestCase):
  # This file should be put to cloud-agent/src/main/python/cloud-agent/debug_testcase_example.py.
