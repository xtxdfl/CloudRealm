...
from cloud_agent.AlertSchedulerHandler import AlertSchedulerHandler
from cloud_agent.RecoveryManager import RecoveryManager
from cloud_agent.alerts.collector import AlertCollector
from cloud_agent.alerts.base_alert import BaseAlert
from cloud_agent.alerts.metric_alert import MetricAlert
from cloud_agent.alerts.port_alert import PortAlert
from cloud_agent.alerts.script_alert import ScriptAlert
from cloud_agent.alerts.web_alert import WebAlert
from cloud_agent.alerts.recovery_alert import RecoveryAlert
from cloud_agent.apscheduler.scheduler import Scheduler
from cloud_agent.ClusterConfigurationCache import ClusterConfigurationCache
...
class TestAlerts(TestCase):
  ...
  def test_start(self, aps_add_interval_job_mock, aps_start_mock):
    test_file_path = os.path.join("cloud_agent", "dummy_files")
    test_stack_path = os.path.join("cloud_agent", "dummy_files")
    test_common_services_path = os.path.join("cloud_agent", "dummy_files")
    test_extensions_path = os.path.join("cloud_agent", "dummy_files")
    test_host_scripts_path = os.path.join("cloud_agent", "dummy_files")
  ...
  def test_recovery_alert(self, rm_get_actions_mock, is_stale_mock):
    ...
    alert.set_cluster("c1", "0", "c6401.cloud.apache.org")
  ...
  def test_port_alert_complex_uri(self, socket_connect_mock, get_configuration_mock):
    ...
    configuration = {
      "hdfs-site": {
        "my-key": "c6401.cloud.apache.org:2181,c6402.cloud.apache.org:2181,c6403.cloud.apache.org:2181"
      }
    }
    ...
    alert.set_cluster("c1", "0", "c6402.cloud.apache.org")
  ...
  def test_port_alert_no_sub(self):
    definition_json = {
      ...
      "source": {
        "type": "PORT",
        "uri": "http://c6401.cloud.apache.org",
        "default_port": 50070,
        "reporting": {
    ...
    self.assertEqual("http://c6401.cloud.apache.org", alert.uri)
  ...
  def test_metric_alert(self, ma_load_jmx_mock, get_configuration_mock):
    ...
    configuration = {
      "hdfs-site": {"dfs.datanode.http.address": "c6401.cloud.apache.org:80"}
    }
  ...
  def test_alert_uri_structure(self, ma_load_jmx_mock, get_configuration_mock):
    ...
    configuration = {
      "hdfs-site": {
        ...
        "dfs.datanode.http.address": "c6401.cloud.apache.org:80",
      }
    }
    ...
    configuration = {
      "hdfs-site": {
        "dfs.http.policy": "HTTP_ONLY",
        "dfs.datanode.https.address": "c6401.cloud.apache.org:443",
      }
    }
  ...
  def test_web_alert(self, wa_make_web_request_mock, get_configuration_mock):
    ...
    self.assertEqual("CRITICAL", alerts[0]["state"])
    self.assertEqual(
      "(Unit Tests) critical: http://c6401.cloud.apache.org:80. error message",
      alerts[0]["text"],
    )
    ...
    configuration = {
      "hdfs-site": {
        ...
        "dfs.datanode.http.address": "c6401.cloud.apache.org:80",
        "dfs.datanode.https.address": "c6401.cloud.apache.org:443/test/path",
      }
    }
    ...
    self.assertEqual("CRITICAL", alerts[0]["state"])
    self.assertEqual(
      "(Unit Tests) critical: https://c6401.cloud.apache.org:443/test/path. error message",
      alerts[0]["text"],
    )
  ...
  def test_immediate_alert(self):
    ...
    execution_commands = [
      {
        "clusterName": "c1",
        "hostName": "c6401.cloud.apache.org",
  ...
  def test_uri_structure_parsing(self, get_configuration_mock):
    ...
    configuration = {
      "hdfs-site": {
        "dfs.namenode.http.address": "c6401.cloud.apache.org:80",
        "dfs.namenode.https.address": "c6401.cloud.apache.org:443",
      }
    }
    ...
    self.assertEqual("c6401.cloud.apache.org:80", uri.uri)
    ...
    uri = alert._get_uri_from_structure(uri_keys)
    self.assertEqual("c6401.cloud.apache.org:443", uri.uri)
    ...
    configuration = {
      "hdfs-site": {
        ...
        "dfs.namenode.http-address.c1ha.nn1": "c6401.cloud.apache.org:8080",
        "dfs.namenode.http-address.c1ha.nn2": "c6402.cloud.apache.org:8080",
      }
    }
    ...
    uri = alert._get_uri_from_structure(uri_keys)
    self.assertEqual("c6401.cloud.apache.org:8080", uri.uri)
    self.assertEqual(False, uri.is_ssl_enabled)
    ...
    configuration = {
      "hdfs-site": {
        ...
        "dfs.namenode.http-address.c1ha.nn1": "c6401.cloud.apache.org:8080",
        "dfs.namenode.http-address.c1ha.nn2": "c6402.cloud.apache.org:8080",
        "dfs.namenode.https-address.c1ha.nn1": "c6401.cloud.apache.org:8443",
        "dfs.namenode.https-address.c1ha.nn2": "c6402.cloud.apache.org:8443",
      }
    }
    ...
    uri = alert._get_uri_from_structure(uri_keys)
    self.assertEqual("c6401.cloud.apache.org:8443", uri.uri)
    self.assertEqual(True, uri.is_ssl_enabled)
  ...
  def test_uri_structure_parsing_without_namespace(self, get_configuration_mock):
    ...
    configuration = {
      "yarn-site": {
        ...
        "yarn.resourcemanager.webapp.address": "c6401.cloud.apache.org:80",
        "yarn.resourcemanager.webapp.http.address": "c6401.cloud.apache.org:443",
        "yarn.resourcemanager.webapp.address.rm1": "c6401.cloud.apache.org:8080",
        "yarn.resourcemanager.webapp.https.address.rm1": "c6401.cloud.apache.org:8443",
        "yarn.resourcemanager.webapp.address.rm2": "c6402.cloud.apache.org:8080",
        "yarn.resourcemanager.webapp.https.address.rm2": "c6402.cloud.apache.org:8443",
    ...
    uri = alert._get_uri_from_structure(uri_keys)
    self.assertEqual("c6402.cloud.apache.org:8443", uri.uri)
    self.assertEqual(True, uri.is_ssl_enabled)
  ...
  def test_alert_definition_value_error_conversion(
    ...
    configuration = {"hdfs-site": {"my-key": "c6401.cloud.apache.org:2181"}}
...
class MockAlert(BaseAlert):
  ...
  def __init__(self):
    super(MockAlert, self).__init__(None, None, CloudConfig())
