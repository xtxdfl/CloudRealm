...
from cloud_commons.os_check import OSConst
from cloud_commons.repo_manager import ManagerFactory
...
from cloud_commons import shell as ac_shell
from cloud_commons.repo_manager.apt_manager import replace_underscores
